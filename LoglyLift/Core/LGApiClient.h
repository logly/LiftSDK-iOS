...
/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one LGApiClient instance per thread.
...
/**
 * LGConfiguration return sharedConfig
 *
 * @return LGConfiguration
 */
