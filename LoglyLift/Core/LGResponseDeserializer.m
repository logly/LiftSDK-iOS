...
NSString *const LGDeserializationErrorDomainKey = @"LGDeserializationErrorDomainKey";

NSInteger const LGTypeMismatchErrorCode = 143553;

NSInteger const LGEmptyValueOccurredErrorCode = 143509;

NSInteger const LGUnknownResponseObjectErrorCode = 143528;


@interface LGResponseDeserializer ()
...
@implementation LGResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:LGDeserializationErrorDomainKey code:LGTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LGDeserializationErrorDomainKey code:LGEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LGDeserializationErrorDomainKey code:LGUnknownResponseObjectErrorCode userInfo:userInfo];
}
