...
NSString * LGPercentEscapedStringFromString(NSString *string) {
    ...
    [allowedCharacterSet removeCharactersInString:[kLGCharactersGeneralDelimitersToEncode stringByAppendingString:kLGCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[LGQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[LGObject class]]) {
