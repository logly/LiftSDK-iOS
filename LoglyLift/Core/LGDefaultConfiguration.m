...
#import "LGBasicAuthTokenProvider.h"
#import "LGLogger.h"

@interface LGDefaultConfiguration ()
...
@implementation LGDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static LGDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [LGBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
